...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="assets/images/shady-192x193.png">

</head>

<body>

  <section class="vh-100" style="background-color: #2865a8;">
                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <form class="mx-1 mx-md-4" action="add.php" method="post">
                    ...
                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <input type="submit" value="Register" name="register" class="btn btn-primary btn-lg text-light my-2 py-3 btn-color" style="width:100% ; border-radius: 30px; font-weight:600;" style="border-radius:25px ;" />

                    </div>

                  </form>
                  <p align="center">i have already account <a href="index.php"  style="font-weight:600; text-decoration:none; color: #2865a8;">Login</a></p>
                </div>
                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">

                  <img src="assets/images/maps.png" class="img-fluid" alt="Sample image" height="300px" width="500px">
